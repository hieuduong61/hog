...
def boar_brawl(player_score, opponent_score):
    ...
    if opponent_tens_digit > 9:
        opponent_tens_digit %= 10
    return 3 * abs(player_one_digit - opponent_tens_digit) or 1
    # END PROBLEM 2
...
def max_scoring_num_rolls(dice=six_sided, samples_count=1000):
    ...
    # BEGIN PROBLEM 9
    "*** YOUR CODE HERE ***"
    max_score = make_averaged(roll_dice)(1,dice)
    num_roll = 1
    i = 2
    while i <= 10:
        if make_averaged(roll_dice)(i,dice) > max_score:
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    after_boar_brawl = score + boar_brawl(score,opponent_score)
    if sus_points(after_boar_brawl) - score >= threshold:
        return 0
    return num_rolls  # Remove this line once implemented.
    # END PROBLEM 11
